<div class="panel panel-default" style="box-shadow: 0 1px 1px rgba(0,0,0,.05);">
    ...
    <div style="border:1px solid #ecf0f1;padding: 20px;" class="panel-body">
        ...
        <a style="background:#18bc9c;color: #212121;padding:10px 20px;border-radius: 10px;text-decoration:none;margin: 10px 0;" href="{{$link}}">
            Profile {{$name_help}}
        </a>
        <p>
            You have been selected to help <strong>{{$name_help}}</strong> move around the country
        </p>
    </div>
