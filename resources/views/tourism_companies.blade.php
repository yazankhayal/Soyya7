...
@section('title') Tourism Companies @endsection
    ...
    <section class="breadcrumb-outer text-center">
        <div class="container">
            <div class="breadcrumb-content">
                <h2>Tourism Companies</h2>
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tourism Companies</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <section class="popular-packages pad-bottom-80">
        <div class="container">
            <div class="section-title">
                <h2>Popular <span>Tourism Companies</span></h2>
                <p>All tourism companies .</p>
            </div>
            <div class="row">
                @if($items->count() > 0)
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="package-item">
                                ...
                                <div class="package-content">
                                    ...
                                    <h3><a href="{{route('tourism_companies_view',['slug'=>$item->slug,'id'=>$item->id])}}">{{$item->name}}</a></h3>
