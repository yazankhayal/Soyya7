        ...
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                <div class="row align-items-center">
                    <div class="col-xl-12">
                        <a href="{{route('travel.add_edit')}}" class="btn btn-primary">
                            Create new
                        </a>
                    </div>
                </div>
    ...
    <div class="modal" id="Modalfile" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form class="ajaxForm travel_file dropzone" id="dropzone" enctype="multipart/form-data" data-name="travel_file" action="{{route('travel.travel_file')}}" method="post">
                    {{csrf_field()}}
    ...
    <script >
        ...
        $(function () {
            ...
            $(document).on('click', '.btnremove', function () {
                ...
                var id2  = id.substr(8);
                $.ajax({
                    url: "{{ route('travel.file_deleted') }}" + "/" + id2,
                    method: 'get',
                    data: {
                    },
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn_remove_gallery', function () {
                var id = $(this).data("id");
                $.ajax({
                    url: "{{ route('travel.file_deleted_by_id') }}" + "/" + id,
                    method: 'get',
                    data: {
                    },
                    success: function(result){
        ...
        var gallery = function (x) {
            $.ajax({
                url:"{{ route('travel.attachments') }}" + "/" + x,
                method:"get",
                dataType:"json",
                success:function(result)
                {
                    ...
                    for(var i = 0; i < result.data.length ; i++){
                        ...
                        var r = '<div class="col-md-3" style="margin-right: 10px;">\n' +
                            '                                <div class="media">\n' +
                            '                                    <img data-img="'+ geturlphoto() + 'travel_file/' + image +'" style="width:100%;height: 60px;" src="'+ geturlphoto() + 'travel_gallery/' + image +'" class="review_img mr-3" alt="...">\n' +
