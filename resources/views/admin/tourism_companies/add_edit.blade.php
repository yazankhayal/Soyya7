    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            <div class="m_datatable m-datatable m-datatable--default m-datatable--loaded" id="local_data" style="">
                <form class="ajaxForm tourism_companies" enctype="multipart/form-data" data-name="tourism_companies" action="{{route('tourism_companies.postdata')}}" method="post">
                    {{csrf_field()}}
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="cls form-control" name="email" id="email" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{route('tourism_companies.index')}}" class="btn btn-secondary" data-dismiss="modal">Cancel</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            if(current_edit != null){
                ...
                $('title').html('Create new tourism_companies | Dashboard');
            }
        ...
        var Countries = function (search) {
            $.ajax({
                url:"{{ route('tourism_companies.countries') }}" ,
                method:"get",
                data:{
                    search : search,
                },
        ...
        var CreateOrEdit = function (x) {
            $.ajax({
                url:"{{route('tourism_companies.getdataid')}}" + "/" + x,
                method:"get",
                dataType:"json",
                success:function(result)
                {
